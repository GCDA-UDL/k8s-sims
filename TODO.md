...
- [ ] **Upload datasets + benchmark results to CORA / RDR** (Repositori de Dades
      ...
      DOI** (Zenodo concept `10.5281/zenodo.20694295`) via related identifiers.
...
- [x] Software DOI on Zenodo: concept `10.5281/zenodo.20694295`, v0.2.2
      `10.5281/zenodo.20694296` (8 authors).
